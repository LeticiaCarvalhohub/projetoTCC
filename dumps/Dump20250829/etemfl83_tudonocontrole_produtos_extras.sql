...
CREATE TABLE `produtos_extras` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo_extra` (`codigo_extra`)
...
LOCK TABLES `produtos_extras` WRITE;
/*!40000 ALTER TABLE `produtos_extras` DISABLE KEYS */;
/*!40000 ALTER TABLE `produtos_extras` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-08-29 14:44:41
